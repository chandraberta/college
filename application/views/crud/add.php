...
<body>
	<form action="<?php echo base_url();?>index.php/crud/action_add" method="post" style="border:1px solid #ccc; text-align: center" class="modal-content">
    ...
    <input type="text" placeholder="Masukkan nama Provinsi" name="alamat" required>

    <label for="email"><b>Email</b></label>
    <input type="text" placeholder="Enter Email" name="email" required>

    <label for="psw"><b>Password</b></label>
    <input type="password" placeholder="Masukkan Password maksimal 10 karakter" name="password" required>

    <label for="psw-repeat"><b>Repeat Password</b></label>
    <input type="password" placeholder="Ulangi Password" name="psw-repeat" required>
    
    <label for="usia"><b>Usia</b></label>
    <input type="number" placeholder="Masukkan usia anda" name="usia" required>
